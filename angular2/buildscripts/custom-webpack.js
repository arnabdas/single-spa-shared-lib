...
const fs = require('fs');
const findUp = require('@angular/cli/utilities/find-up');
const BrowserBuilderOptions = require('@angular-devkit/build-angular');

const defaultExtraOptions = {
  removeMiniCssExtract: true,
};

module.exports = (config, options, extraOptions) => {
...
function getProjectNameFromAngularJson(options) {
  ...
  try {
    ...
    return projects.find(
      project => options? angularJson.projects[project].architect.build.options.main === options.main: false,
    );
  } catch {
